...
def setup_logging():
    ...
    print("Logging configured for production deployment", flush=True)
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Backend API for AI Meeting Summary and CRM Note Generator",
        version="1.0.0",
        lifespan=lifespan
    )
...
def setup_static_files(app: FastAPI):
    ...
    if static_dir.exists():
        ...
        try:
            ...
            print(f"Error listing dist directory: {e}", flush=True)
    else:
...
if __name__ == "__main__":
    # Configure memory optimization for production
    import gc
    ...
    print("Memory optimization enabled", flush=True)
