  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Action Items</h1>
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {filteredItems.length > 0 ? (
              ...
              >
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <button 
                    ...
                    className="mt-1 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 flex-shrink-0"
                  >
                    {item.completed ? (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 mt-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400 space-y-1 sm:space-y-0">
                      ...
                      <span className="text-blue-600 dark:text-blue-400 truncate">From: {item.meeting_title}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sm:p-8 text-center">
              <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">No action items found.</p>
            </div>
          )}
        </div>
      )}
